d3 = function() {
  ...
  d3.layout.tree = function() {
    ...
    function tree(d, i) {
      ...
      // here we change the tree view when new node added or remove.
      // due to this code tree will not shrink into svg size but it will take proper space for each node and expand tree
